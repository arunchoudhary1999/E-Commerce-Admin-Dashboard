...
function PaymentsManagementTable(props) {
...
PaymentsManagementTable.propTypes = {
  numSelected: PropTypes.number.isRequired,
};
  ...
  return (
    <Box sx={{ width: "100%" }}>
      <Paper sx={{ width: "100%", mb: 2, borderRadius: "8px" }}>
        <PaymentsManagementTable numSelected={selected.length} />
        <TableContainer>
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">
                      <span
                        style={{
                          ...
                          padding: "3.97px 10.91px 3.97px 10.91px",
                          borderRadius: "7.93px",
                    ...
                    <TableCell align="right">
                      <span
                        style={{
                          background: "rgba(244, 6, 7, 0.16)",
                          padding: "3.97px 10.91px 3.97px 10.91px",
                          borderRadius: "7.93px",
                          color: "rgba(244, 6, 7, 1)",
                          fontFamily: "Inter",
                          // fontSize: "11.9px",
                        }}
                      >
